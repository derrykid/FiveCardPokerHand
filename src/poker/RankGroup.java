...
public class RankGroup implements Iterable<Map.Entry<Rank, List<Card>>> {
    ...
    private static Map<Rank, List<Card>> initRankGroup(SortedSet<Card> cards) {
        ...
        // My copying
//        // TODO create the list to be sorted
//        List<Map.Entry<Rank, List<Card>>> listOfEntries = new ArrayList<>(cards.
//                stream().
//                collect(Collectors.groupingBy(Card::getRank)).
//                entrySet());
//
//        // TODO comparator
//        Comparator<Map.Entry<Rank, List<Card>>> rankComparator =
//                (o1, o2) -> o2.getValue().size() == o1.getValue().size() ? o2.getKey().getRankValue() - o1.getKey().getRankValue() : o2.getValue().size() - o1.getValue().size();
//
//        listOfEntries.sort(rankComparator);
//        // TODO create map
//        Map<Rank, List<Card>> rankMap = new LinkedHashMap<>();
//        // TODO insert into map
//        for (Map.Entry<Rank, List<Card>> per: listOfEntries) {
//            rankMap.put(per.getKey(), per.getValue());
//        }
//        // TODO return
